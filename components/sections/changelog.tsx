import { ChangelogView } from "@/components/sections/changelog-view";
...
// Server component: fetches release data at build time, then hands it to the
// client view that localizes the labels.
